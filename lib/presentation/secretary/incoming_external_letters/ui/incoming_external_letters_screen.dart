...
class IncomingExternalLettersScreen extends StatelessWidget {
  const IncomingExternalLettersScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<IncomingExternalLettersCubit>()..getIncomingLetters(),
      child: BlocConsumer<IncomingExternalLettersCubit,IncomingExternalLettersStates>(
        listener: (context, state){},
        builder: (context, state){
          var cubit = IncomingExternalLettersCubit.get(context);
          return Scaffold(
            ...
            body: FadeIn(
              ...
              child: Column(
                children: [
                  ...
                  state is IncomingExternalLettersLoadingLetters ?  Expanded(child: Center(child: loadingIndicator(),)) :
  ...
  Widget searchAndFilterWidget(BuildContext context, IncomingExternalLettersCubit cubit){
    return Container(
  ...
  Widget headerItem(BuildContext context, IncomingExternalLettersCubit cubit){
    return Padding(
  ...
  Widget letterItem(BuildContext context, IncomingExternalLettersCubit cubit, int index){
    return Padding(
      padding: const EdgeInsets.all(AppSize.s8),
      child: Material(
        color: Theme.of(context).splashColor,
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  cubit.formatDate(cubit.filteredLettersList[index].letterDate!),
                  style: TextStyle(
                      color: Theme.of(context).primaryColorDark,
                      fontFamily: FontConstants.family,
                      fontSize: AppSize.s16,
