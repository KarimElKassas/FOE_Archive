...
import 'package:foe_archive/presentation/secretary/outgoing_internal_letters/bloc/outgoing_internal_letters_cubit.dart';
...
class OutgoingInternalLettersScreen extends StatelessWidget {
  const OutgoingInternalLettersScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<OutgoingInternalLettersCubit>()..getOutgoingLetters(),
            ...
            body: FadeIn(
              ...
              child: Column(
                children: [
                  ...
                  state is OutgoingInternalLettersLoadingLetters ?  Expanded(child: Center(child: loadingIndicator(),)) :
  ...
  Widget letterItem(BuildContext context, OutgoingInternalLettersCubit cubit, int index){
    return Padding(
      padding: const EdgeInsets.all(AppSize.s8),
      child: Material(
        color: Theme.of(context).splashColor,
