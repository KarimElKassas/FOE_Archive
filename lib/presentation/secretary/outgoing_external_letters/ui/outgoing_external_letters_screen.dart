...
class OutgoingExternalLettersScreen extends StatelessWidget {
  const OutgoingExternalLettersScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<OutgoingExternalLettersCubit>()..getOutgoingLetters(),
            ...
            body: FadeIn(
              ...
              child: Column(
                children: [
                  ...
                  state is OutgoingExternalLettersLoadingLetters ?  Expanded(child: Center(child: loadingIndicator(),)) :
  ...
  Widget letterItem(BuildContext context, OutgoingExternalLettersCubit cubit, int index){
    return Padding(
      padding: const EdgeInsets.all(AppSize.s8),
      child: Material(
        color: Theme.of(context).splashColor,
