...
class IncomingLettersScreen extends StatelessWidget {
  const IncomingLettersScreen({Key? key}) : super(key: key);
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<IncomingLettersCubit,IncomingLettersStates>(
        ...
        builder: (context, state){
          var cubit = IncomingLettersCubit.get(context);
          return Scaffold(
  ...
  Widget headerItem(BuildContext context, IncomingLettersCubit cubit){
    return Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          Navigator.pushNamed(
              ...
              arguments: LetterDetailsArgs(lettersList[index], 1,false));
        },
            borderRadius: const BorderRadius.all(Radius.circular(AppSize.s10)),
