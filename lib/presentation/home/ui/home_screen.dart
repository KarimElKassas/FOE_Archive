...
import 'package:foe_archive/presentation/archived_letter/ui/archived_letters_screen.dart';
...
import '../../archived_letter/ui/new_archived_letters_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<HomeCubit>()..getAllLetters()..initSortMethod(),
      child: BlocConsumer<HomeCubit, HomeStates>(
        listener: (context, state) {
          if(state is HomeGetDirectionsError){
            print("ERROR STATE : ${state.error}");
          }
          if(state is HomeGetLettersError){
  ...
  Widget allLetters(BuildContext context, HomeCubit cubit, HomeStates state){
    return FadeIn(
      ...
      child: Column(
        children: [
          ...
          state is HomeLoadingLetters ?  Expanded(child: Center(child: loadingIndicator(),)) :
  ...
  Widget sideMenuItem(BuildContext context, HomeCubit cubit,
  ...
  Widget filterDialog(BuildContext context, HomeCubit cubit) {
    bool isClosing = false;
                ...
                child: SingleChildScrollView(
                  child: ListBody(
                    children: <Widget>[
                      ...
                      FilterByDirectionComponent(cubit: cubit,)
  ...
  Widget searchAndFilterWidget(BuildContext context, HomeCubit cubit){
    return Container(
      decoration: BoxDecoration(
  ...
  Widget headerItem(BuildContext context, HomeCubit cubit){
    return Padding(
  ...
  Widget letterItem(BuildContext context, HomeCubit cubit, int index){
    return Padding(
      padding: const EdgeInsets.all(AppSize.s8),
      child: Material(
        color: Theme.of(context).splashColor,
  ...
  Widget filterItem(BuildContext context, HomeCubit cubit, String label){
    return Container(
      decoration: BoxDecoration(
