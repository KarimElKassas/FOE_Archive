...
class LocalLettersScreen extends StatelessWidget {
  const LocalLettersScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<ArchivedLettersCubit>()..getForMeLetters(),
            ...
            body: FadeIn(
              ...
              child: Column(
                children: [
                  ...
                  state is ArchivedLettersLoadingLetters ?  Expanded(child: Center(child: loadingIndicator(),)) :
  ...
  Widget headerItem(BuildContext context, ArchivedLettersCubit cubit){
    return Padding(
  ...
  Widget letterItem(BuildContext context, ArchivedLettersCubit cubit, int index){
    return Padding(
      padding: const EdgeInsets.all(AppSize.s8),
      child: Material(
        color: Theme.of(context).splashColor,
